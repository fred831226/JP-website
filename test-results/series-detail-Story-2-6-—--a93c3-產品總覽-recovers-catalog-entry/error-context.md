...
- Name: series-detail.spec.ts >> Story 2.6 — Media dialog and Contact continuation >> 返回產品總覽 recovers catalog entry
- Location: tests/e2e/series-detail.spec.ts:122:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3010/zh-tw/series/hs
Call log:
  - navigating to "http://localhost:3010/zh-tw/series/hs", waiting until "load"
