...
- Name: navigation.spec.ts >> Story 1.2 — public navigation >> Footer includes identity, nav, and contact
- Location: tests/e2e/navigation.spec.ts:99:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3010/zh-tw
Call log:
  - navigating to "http://localhost:3010/zh-tw", waiting until "load"
