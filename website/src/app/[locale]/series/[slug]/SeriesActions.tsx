  ...
  return (
    <>
      <button
        ...
        className="flex aspect-[4/3] w-full max-w-lg items-center justify-center overflow-hidden rounded-[var(--product-card-radius)] bg-white shadow-[var(--product-card-shadow)] focus-visible:outline-[3px] focus-visible:outline-[var(--color-focus-ring)]"
