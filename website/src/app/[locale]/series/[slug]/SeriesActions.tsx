    ...
    <>
      <div className="flex flex-col gap-3">
        <div className="relative">
          ...
          >
            <img src={active} alt={activeAlt} className="h-full w-full object-contain p-4" />
          </button>
          ...
          {multiple && (
            <>
              <button
                type="button"
                onClick={goPrev}
                className="absolute left-2 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-[var(--color-primary)] shadow-[0_2px_10px_rgba(11,42,61,.15)] transition-colors hover:bg-white focus-visible:outline-[3px] focus-visible:outline-[var(--color-focus-ring)]"
                aria-label="上一張圖片"
              >
              ...
              <button
                type="button"
                onClick={goNext}
                className="absolute right-2 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-[var(--color-primary)] shadow-[0_2px_10px_rgba(11,42,61,.15)] transition-colors hover:bg-white focus-visible:outline-[3px] focus-visible:outline-[var(--color-focus-ring)]"
                aria-label="下一張圖片"
              >
      ...
      {open && <ImageDialog src={active} alt={activeAlt} onClose={() => setOpen(false)} />}
    </>
  );
}
