...
// Reads: data/source-catalog.xlsx -> Writes: data/catalog.generated.json
...
/** Canonical display name per source label, from governed catalog-types.json */
function loadPumpTypeCanonicalNames() {
...
async function run() {
  ...
  const pumpTypeCanonical = loadPumpTypeCanonicalNames();
  ...
  for (const row of rows) {
    ...
    const pumpType = pumpTypeCanonical.get(ptRaw) || ptRaw;
