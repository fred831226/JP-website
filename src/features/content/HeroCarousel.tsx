...
export default function HeroCarousel({ images, fallbackImage }: HeroCarouselProps) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div className="absolute bottom-4 right-4 z-20 max-w-[360px] rounded-[var(--radius-sm)] bg-[var(--color-primary)]/88 px-2.5 py-1.5 text-xs text-[var(--color-contact-text-muted)] shadow-[var(--shadow-control)]">
